...
See [`docs/proposal.md`](docs/proposal.md) for the original design proposal and hardware rationale, and [`docs/architecture.md`](docs/architecture.md) for the as-built architecture (an HTTP-first revision of that proposal - see below).
